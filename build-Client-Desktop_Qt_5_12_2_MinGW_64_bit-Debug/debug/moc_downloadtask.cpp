...
QT_MOC_LITERAL(1, 13, 17), // "downloadCompleted"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 7) // "content"

    },
    "DownloadTask\0downloadCompleted\0\0content"
};
...
void DownloadTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->downloadCompleted((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DownloadTask::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DownloadTask::downloadCompleted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DownloadTask::downloadCompleted(const QByteArray & _t1)
{
